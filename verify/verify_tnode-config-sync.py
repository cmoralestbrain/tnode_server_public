#!/usr/bin/env python3
"""verify_tnode-config-sync — health check del daemon HMAC pull de LLM config."""
...
COMPONENT_ID = "tnode-config-sync"
SERVICE_NAME = "tnode-config-sync"
SCRIPT_PATH = Path.home() / ".openclaw" / "scripts" / "tnode_config_sync.py"
CONFIG_PATH = Path.home() / ".openclaw" / "tnode-chat-sync.json"
LOG_PATH = Path.home() / ".openclaw" / "logs" / "tnode-config-sync.log"
